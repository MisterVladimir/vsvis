...
class Ui_file_inspection_dialog(object):
    def setupUi(self, file_inspection_dialog):
        ...
        self.verticalLayout_5 = QtWidgets.QVBoxLayout(self.images_groupbox)
        ...
        self.verticalLayout_5.addWidget(self.images_list_view)
        ...
        self.verticalLayout_5.addWidget(self.images_sort_button)
        ...
        self.verticalLayout_6 = QtWidgets.QVBoxLayout(self.roi_groupbox)
        ...
        self.roi_list_view.setEditTriggers(QtWidgets.QAbstractItemView.EditKeyPressed)
